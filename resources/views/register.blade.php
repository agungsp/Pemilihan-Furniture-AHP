                    ...
                    <div class="card-body p-5">
                        <form class="user" action="/register" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="password" name="confirmPassword" id="confirmPassword" class="form-control form-control-user" placeholder="Konfirmasi Password...">
                                </div>
                            </div>
                            <button type="submit" name="sumbit" class="btn btn-primary btn-user btn-block"><i class="fas fa-user-plus"></i> Register</button>
                            <hr>
                        </form>
                        <div class="text-center">
